...
const NAMA_KEDAI = "Kedai Kopi Nayla Sucia";
let namaKasir = "Kak Fahira";
let shiftKerja = "Sore";
...
namaKasir = "Kak Sesey";
console.log("Kasir setelah diubah : " + namaKasir);
...
alert(
    "☕✨ Selamat datang di Kedai Kopi Nayla Sucia! ✨☕\n\n" +
    "Kami siap menemani harimu dengan kopi terbaik 💕"
);

let namaPelanggan = prompt(
    "🍰 Hai pelanggan Kedai Kopi Nayla Sucia!\n\n" +
...
if (namaPelanggan) {
    alert(
        "Halo " + namaPelanggan + "!! 🥰\n\n" +
        "Selamat datang di Kedai Kopi Nayla Sucia ☕✨\n" +
        "Semoga hari kamu selalu happy yaaak 💕"
    );
    ...
    alert(
        "Tidak apa-apa 😊\n\n" +
        "Kami tetap senang melayani kamu, Pelanggan Setia 💕☕"
    );
